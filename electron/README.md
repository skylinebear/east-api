# EASTCREA Electron Desktop App

This directory contains the Electron wrapper for EASTCREA, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/EASTCREA/data/`
  - Windows: `%APPDATA%/EASTCREA/data/`
  - Linux: `~/.config/EASTCREA/data/`
