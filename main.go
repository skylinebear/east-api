...
import (
	...
	"github.com/skylinebear/new-api/router"
	"github.com/skylinebear/new-api/service"
	_ "github.com/skylinebear/new-api/setting/performance_setting"
...
func InjectUmamiAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Umami EASTCREA-->\n")
...
func InjectGoogleAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Google Analytics EASTCREA-->\n")
	analyticsInject := analyticsInjectBuilder.String()
